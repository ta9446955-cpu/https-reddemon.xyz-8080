...
| 📦 **Addon zip** (v1.0.1, install directly, no auto-updates) | [plugin.video.reddemon-1.0.1.zip](https://raw.githubusercontent.com/ta9446955-cpu/https-reddemon.xyz-8080/main/plugin.video.reddemon/plugin.video.reddemon-1.0.1.zip) |
...
2. **Go to**: Kodi > Settings > Add-ons > Install from zip file
3. **Select** the downloaded `plugin.video.reddemon-1.0.1.zip`
4. **Restart** Kodi
