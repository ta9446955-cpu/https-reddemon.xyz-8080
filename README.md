...
| 📦 **Addon zip** (v1.1.3, install directly, no auto-updates) | [plugin.video.reddemon-1.1.3.zip](https://raw.githubusercontent.com/ta9446955-cpu/https-reddemon.xyz-8080/main/plugin.video.reddemon/plugin.video.reddemon-1.1.3.zip) |
...
2. **Go to**: Kodi > Settings > Add-ons > Install from zip file
3. **Select** the downloaded `plugin.video.reddemon-1.1.3.zip`
4. **Restart** Kodi
...
- **My Playlists** - browse all your own YouTube playlists
- **Search This Playlist** - find a video quickly within a large playlist (appears at the top of any playlist's video list)
- **Search YouTube** - search all of YouTube from the main menu, not just your own playlists
